    ...
    function Tab:CraftTab(text)
        ...
        function Page:CraftPage(text,Type)
            ...
            function Item:ToggleS(text,default,callback)
                ...
                ToggleSBtn.MouseLeave:Connect(function()
                    if (togglechecks == true and lockers == true) or checkentertoggles == true then
                        checkentertoggles = false
                        TweenService:Create(
                            LabelToggleS,
            ...
            function Item:MultiDropdown(text,item,default,callback)
                ...
                MultiDropDownFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
                ...
                MultiLabel_Drop.TextColor3 = Color3.fromRGB(120,120,120)
                ...
                MultiDown.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
                ...
                for i,v in pairs(item) do
                    ...
                    MultiItem.BackgroundColor3 = Color3.fromRGB(0, 155, 255)
                ...
                MultiDrop_Frame.MouseEnter:Connect(function()
                    if Multidroptween == true then
                        TweenService:Create(
                            MultiLabel_Drop,
                            TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out,0.1),
                            {TextColor3 = Color3.fromRGB(255,255,255)}
                ...
                MultiDrop_Frame.MouseLeave:Connect(function()
                    if Multidroptween == true then
                        TweenService:Create(
                            MultiLabel_Drop,
                            TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out,0.1),
